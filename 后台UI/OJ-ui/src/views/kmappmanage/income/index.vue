<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="收入说明" prop="comment">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['kmappmanage:income:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['kmappmanage:income:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['kmappmanage:income:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kmappmanage:income:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="incomeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收入说明" align="center" prop="comment" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="收入说明" prop="comment">
          <el-input v-model="form.comment" placeholder="请输入收入说明" />
        </el-form-item>
        <el-form-item label="金额显示颜色" prop="color">
...
<script>
import { listIncome, getIncome, delIncome, addIncome, updateIncome } from "@/api/kmappmanage/income";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户收入编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('kmappmanage/income/export', {
        ...this.queryParams
